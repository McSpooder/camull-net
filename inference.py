...
def run(task=-1, weights_dir="../weights/", sample_loc="../data/inference"):

    if (task == -1):
        task = input("Input the task you want to perform [AD vs CN: 0, sMCI vs pMCI: 1]: ")
    ...
    if (Path('../weights').exists()):
        ...
        weights_path = "../weights/CN_v_AD/c51bf83c4455416e8bc8b1ebbc8b75ca/fold_5_weights-2020-04-29_13:17:33"
        print("\n")
